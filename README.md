...
Built using dlib's HOG detector for facial detection, face_recognition by Adam Geitgey for extracting face encodings and an SVM classifier to classify unknown embedding.
